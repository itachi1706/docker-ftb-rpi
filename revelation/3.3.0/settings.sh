...
export FORGEJAR="forge-1.12.2-14.23.5.2846-universal.jar"
...
export JAVACMD="java"
export MIN_RAM="${MC_MIN:-512M}"        # -Xms
export MAX_RAM="${MC_MAX:-3072M}"       # -Xmx
export PERMGEN_SIZE="${MC_PERMGEN:-256M}"   # -XX:PermSize
